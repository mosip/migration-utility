package io.mosip.pms.pii.encryptutility.util;
...
import io.mosip.pms.pii.encryptutility.constants.ErrorCode;
import io.mosip.pms.pii.encryptutility.exception.PartnerPiiEncryptUtilityException;
    ...
    public String encryptData(String data) {
        try {
            ...
            if (response == null) {
                ...
                throw new PartnerPiiEncryptUtilityException(ErrorCode.API_NULL_RESPONSE.getErrorCode(),
            ...
            if (response.containsKey(PartnerConstants.ERRORS)) {
                ...
                if (errorList != null && !errorList.isEmpty()) {
                    ...
                    throw new PartnerPiiEncryptUtilityException(String.valueOf(errorList.get(0).get(PartnerConstants.ERRORCODE)),
            ...
            throw new PartnerPiiEncryptUtilityException(ErrorCode.ENCRYPTION_FAILED.getErrorCode(), ErrorCode.ENCRYPTION_FAILED.getErrorMessage());
        }
    }
} 